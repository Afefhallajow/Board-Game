 ...
 * @author TOSHIBA
 */
public class normal_attack extends do_attack implements Serializable{
    
    public normal_attack(Champoin obj,player []players,player this_player){
    
        super(obj,players,this_player);
    }
    
    
    public void do_normal_attact(String name_to_att){
       // System.out.println("do_normal_attact");
    ...
    //System.out.println("aaaaaa8888"+obj.get_attack_damage());
    champoin_target.get(j).takedammage(obj.get_attack_damage());
    obj.increase_mena(1);
    obj.increase_str_chance();
    ...
    System.out.println(obj.get_name()+" attacked "+name_to_att+" !!");
    }
    }
